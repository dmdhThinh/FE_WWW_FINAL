...
const CartSidebarModal = () => {
  ...
  useEffect(() => {
    // Only fetch cart items when modal opens if cart hasn't been initialized yet
    if (isCartModalOpen && !isInitialized) {
      dispatch(fetchCartItems());
    }
  }, [isCartModalOpen, dispatch, isInitialized]);
  ...
  return (
    <div className="fixed top-0 left-0 z-99999 overflow-y-auto no-scrollbar w-full h-screen bg-dark/70 ease-linear duration-300">
